...
All the environments are registered in the `Tiago_manipulation` extension. They start
...
import Tiago_manipulation.tasks  # noqa: F401


def main():
    """Print all environments registered in `Tiago_manipulation` extension."""
